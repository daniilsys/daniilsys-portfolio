...
export default function Home() {
  ...
  useEffect(() => {
    ...
    [projectsRef, freelanceRef].forEach((ref) => {
      ...
      ref.current.querySelectorAll("[data-project-row]").forEach((row) => observer.observe(row));
    });
  ...
  return (
    <div ref={sectionsRef}>
      ...
      <main className="min-h-screen relative">
        ...
        {/* ── Hero ── */}
        <section ref={heroRef} className="h-screen flex flex-col justify-center md:justify-end px-6 pb-0 md:pb-16 md:px-16 lg:px-24 relative overflow-hidden">
          {/* Cursor glow */}
        ...
        {/* ── Freelance Work ── */}
        <section className="section-reveal px-6 pt-32 pb-16 md:px-16 lg:px-24" ref={freelanceRef}>
...
function ProjectRow({
  ...
  const crate = useCrateStats("crate" in project ? (project as { crate?: string }).crate : undefined);
